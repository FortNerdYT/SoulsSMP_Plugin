...
public enum SoulType {
    ...
    VAMPIRE(ChatColor.DARK_RED, Material.NETHER_WART, SoulRarity.MYTHIC, "Heal 30% of damage dealt",1010),
    ...
    SoulType(ChatColor color, Material material, SoulRarity rarity, String description, int CMD) {
        this.color = color;
